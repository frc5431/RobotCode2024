...
public class TitanDrivebase {
    ...
    public Lock odometryLock = new ReentrantLock();
     ...
     */
    public TitanDrivebase(SwerveDrivetrainConstants driveTrainConstants, SwerveModuleConstants... modules) {
