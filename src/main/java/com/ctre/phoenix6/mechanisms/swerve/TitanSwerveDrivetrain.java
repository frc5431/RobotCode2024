 ...
 */
public class TitanSwerveDrivetrain {
    ...
    protected TitanSwerveDrivePoseEstimator m_odometry;
     ...
     */
    public TitanSwerveDrivetrain(SwerveDrivetrainConstants driveTrainConstants, SwerveModuleConstants... modules) {
    ...
    public TitanSwerveDrivetrain(
        ...
        m_odometry = new TitanSwerveDrivePoseEstimator(m_kinematics, new Rotation2d(), m_modulePositions, new Pose2d(), odometryStandardDeviation, visionStandardDeviation);
