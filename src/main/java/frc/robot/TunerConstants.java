...
public class TunerConstants {
    ...
    .withMountPose(new MountPoseConfigs().withMountPoseYaw(45));
    ...
    public static final ModuleConfig moduleConfig = new ModuleConfig(1.0, kSpeedAt12Volts.baseUnitMagnitude(), kDriveFrictionVoltage.baseUnitMagnitude(), DCMotor.getFalcon500(4), 80, 0);
