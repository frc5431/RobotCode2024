 ...
 *
 * <p>{@link TitanSwerveDrivePoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link TitanSwerveDrivePoseEstimator#addVisionMeasurement} can be called as infrequently as you
 * want; if you never call it, then this class will behave as regular encoder odometry.
 */
public class TitanSwerveDrivePoseEstimator extends TitanPoseEstimator<SwerveDriveWheelPositions> {
   ...
   */
  public TitanSwerveDrivePoseEstimator(
