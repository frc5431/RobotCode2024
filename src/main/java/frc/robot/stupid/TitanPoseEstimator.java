...
public class TitanPoseEstimator<T extends WheelPositions<T>> {
  ...
  public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
    ...
    var set = m_poseBuffer.getInternalBuffer().tailMap(timestampSeconds).entrySet().stream().collect(Collectors.toList());
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof TitanPoseEstimator.InterpolationRecord)) {
        return false;
      }
      var record = (TitanPoseEstimator<?>.InterpolationRecord) obj;
