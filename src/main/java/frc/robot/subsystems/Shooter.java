...
public class Shooter extends Manipulator {
     ...
     * @return empty if never fired, otherwise returns the timestamp in epoch miliseconds
     */
     ...
     * @return whether or not a game piece was fired since this method was last called. It will return false if a game piece is currently contained <br>
     */
    @Override
