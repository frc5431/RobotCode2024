...
import frc.robot.commands.RunAmperPivotCommand;
...
public class HandoffCommand extends SequentialCommandGroup {
    ...
    public HandoffCommand(Intake intake, Pivot intakePivot, AmperPivot amperPivot, Amper amper) {
        addCommands(
                new RunAnglerCommand(() -> Constants.IntakeConstants.ampAngle.in(Units.Degrees), intakePivot, TerminationCondition.SETPOINT_REACHED).alongWith(
                        new RunAmperPivotCommand(() -> Constants.AmperConstants.anglerConstants.minAngle.in(Units.Degrees), amperPivot, frc.robot.commands.RunAmperPivotCommand.TerminationCondition.SETPOINT_REACHED)),
                Commands.race(
