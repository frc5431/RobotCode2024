...
//   public DefaultDriveCommand(Systems systems, Supplier<Pair<Double, Double>> magThetaSupplier, DoubleSupplier rotationSupplier) {
//     this(
//       systems,
...
//     m_drivetrainSubsystem.(ChassisSpeeds.fromFieldRelativeSpeeds(x, y, rot, m_drivetrainSubsystem.getPigeon2().getRotation2d()));
//   }
